...
// Sluitknop die terugkeert naar de vorige pagina (bv. de groepsfase + groep
// waar je vandaan kwam). Valt terug op /statistieken bij directe navigatie.
